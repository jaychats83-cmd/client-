...
public class ParticleRenderer {
    ...
    private static final Identifier GLOW_TEXTURE = Identifier.of("starry", "textures/world/dashbloom.png");
    private static final Identifier GLOW_TEXTURE_SECONDARY = Identifier.of("starry", "textures/world/dashbloomsample.png");
