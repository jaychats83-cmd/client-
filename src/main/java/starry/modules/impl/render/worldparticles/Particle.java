package starry.modules.impl.render.worldparticles;
...
public class Particle implements IMinecraft {
    ...
    private static final Identifier TEXTURE_CROWN = Identifier.of("starry", "textures/world/crown.png");
    private static final Identifier TEXTURE_CUBE_BLAST = Identifier.of("starry", "textures/world/cubeblast1.png");
    private static final Identifier TEXTURE_DOLLAR = Identifier.of("starry", "textures/world/dollar.png");
    private static final Identifier TEXTURE_HEART = Identifier.of("starry", "textures/world/heart.png");
    private static final Identifier TEXTURE_LIGHTNING = Identifier.of("starry", "textures/world/lightning.png");
    private static final Identifier TEXTURE_LINE = Identifier.of("starry", "textures/world/line.png");
    private static final Identifier TEXTURE_RHOMBUS = Identifier.of("starry", "textures/world/rhombus.png");
    private static final Identifier TEXTURE_SNOWFLAKE = Identifier.of("starry", "textures/world/snowflake.png");
    private static final Identifier TEXTURE_STAR = Identifier.of("starry", "textures/world/star.png");
    private static final Identifier TEXTURE_STAR_ALT = Identifier.of("starry", "textures/world/star1.png");
    private static final Identifier TEXTURE_TRIANGLE = Identifier.of("starry", "textures/world/triangle.png");
    private static final Identifier TEXTURE_GLOW = Identifier.of("starry", "textures/world/dashbloom.png");

    private static final Identifier GLOW_BLOOM = Identifier.of("starry", "textures/world/dashbloom.png");
    private static final Identifier GLOW_BLOOM_SAMPLE = Identifier.of("starry", "textures/world/dashbloomsample.png");
