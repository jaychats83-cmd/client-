...
public class o8zfl9 extends ModuleStructure {
    public static o8zfl9 getInstance() {
        return Instance.get(o8zfl9.class);
    }

    final List<WaveEffect> waveEffects = Collections.synchronizedList(new ArrayList<>());

    public ColorSetting colorSetting = new ColorSetting("Color", "Select effect color")
            .setColor(new Color(137, 97, 72, 255).getRGB());

    public o8zfl9() {
        super(StringHelper.decrypt(new byte[]{2, (byte)-86, 43, (byte)-83, 116, (byte)-3, 82, (byte)-75, 62}), StringHelper.decrypt(new byte[]{2, (byte)-86, 43, (byte)-56, 87, (byte)-3, 81, (byte)-77, 41, (byte)-73}), ModuleCategory.VISUALS);
