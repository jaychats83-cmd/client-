package starry.modules.impl.render.chinahat;
...
import starry.modules.impl.render.dl3shr;
...
public class ChinaHatFeatureRenderer extends FeatureRenderer<PlayerEntityRenderState, PlayerEntityModel> {
    ...
    public void render(MatrixStack matrixStack, OrderedRenderCommandQueue queue, int light, PlayerEntityRenderState state, float limbAngle, float limbDistance) {
        ...
        dl3shr chinaHat = dl3shr.getInstance();
    ...
    private void renderFlatHat(MatrixStack stack, VertexConsumerProvider provider, dl3shr chinaHat) {
    ...
    private void renderOutline(MatrixStack stack, VertexConsumerProvider provider, dl3shr chinaHat) {
    ...
    private int getGradientColor(int index, int size, dl3shr chinaHat, float animSpeed) {
