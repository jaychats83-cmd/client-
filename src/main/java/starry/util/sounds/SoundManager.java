...
public class SoundManager implements IMinecraft {
    public SoundEvent KOLOKOLNIA_KILL = SoundEvent.of(Identifier.of("starry:kolokolnia_kill"));
    public SoundEvent MOAN1 = SoundEvent.of(Identifier.of("starry:moan1"));
    public SoundEvent MOAN2 = SoundEvent.of(Identifier.of("starry:moan2"));
    public SoundEvent MOAN3 = SoundEvent.of(Identifier.of("starry:moan3"));
    public SoundEvent MOAN4 = SoundEvent.of(Identifier.of("starry:moan4"));
    public SoundEvent MODULE_DISABLE = SoundEvent.of(Identifier.of("starry:module_disable"));
    public SoundEvent MODULE_ENABLE = SoundEvent.of(Identifier.of("starry:module_enable"));
    public SoundEvent OFF = SoundEvent.of(Identifier.of("starry:off"));
    public SoundEvent ON = SoundEvent.of(Identifier.of("starry:on"));
    public SoundEvent CRIME = SoundEvent.of(Identifier.of("starry:crime"));
    public SoundEvent METALLIC = SoundEvent.of(Identifier.of("starry:metallic"));
    public SoundEvent WELCOME = SoundEvent.of(Identifier.of("starry:welcome"));
