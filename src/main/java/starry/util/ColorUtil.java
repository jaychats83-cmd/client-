...
public class ColorUtil {
    ...
    public int getMainGuiColor() {
        try { return ThemeManager.getTheme().mainBg; } catch (Exception e) { return new Color(20, 20, 24, 255).getRGB(); }
    }

    public int getGuiRectColor(float alpha) {return multAlpha(getGuiRectColor(),alpha);}
    public int getGuiRectColor() {
        try { return ThemeManager.getTheme().panelBg; } catch (Exception e) { return new Color(0x1A1A1F).getRGB(); }
    }
    public int getGuiRectColor2(float alpha) {return multAlpha(getGuiRectColor2(),alpha);}
    public int getGuiRectColor2() {
        try { return ThemeManager.getTheme().panelBg2; } catch (Exception e) { return new Color(0x1E1E26).getRGB(); }
    }
    ...
    public int getText() {
        try { return ThemeManager.getTheme().text; } catch (Exception e) { return new Color(255,255,255,255).getRGB(); }
    }

    public int getText2() {
        try { return ThemeManager.getTheme().text2; } catch (Exception e) { return new Color(175, 175, 175,255).getRGB(); }
    }
    ...
    public int getOutline() {
        try { return ThemeManager.getTheme().outline; } catch (Exception e) { return new Color(0x373746).getRGB(); }
    }
}