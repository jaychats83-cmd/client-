package starry.util.render.clientpipeline;
...
public class ClientPipelines {
    ...
    public static final RenderPipeline WORLD_PARTICLES_COLOR_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.POSITION_COLOR_SNIPPET)
                    .withLocation(Identifier.of("starry", "world_particles_color"))
                    .withVertexFormat(VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.QUADS)
                    .withCull(false)
                    .withDepthTestFunction(DepthTestFunction.LEQUAL_DEPTH_TEST)
                    .withDepthWrite(false)
    ...
    public static final RenderPipeline WORLD_PARTICLES_LINES_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.POSITION_COLOR_SNIPPET)
                    .withLocation(Identifier.of("starry", "world_particles_lines"))
    ...
    public static final RenderPipeline WORLD_PARTICLES_GLOW_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.POSITION_TEX_COLOR_SNIPPET)
                    .withLocation(Identifier.of("starry", "world_particles_glow"))
                    .withVertexFormat(VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS)
                    .withCull(false)
                    .withDepthTestFunction(DepthTestFunction.LEQUAL_DEPTH_TEST)
                    .withDepthWrite(false)
    ...
    public static final RenderPipeline CHAMS_THROUGH_WALLS = RenderPipelines.register(
            RenderPipeline.builder(TRANSFORMS_AND_PROJECTION_SNIPPET)
                    .withLocation("pipeline/chams_through_walls")
                    .withVertexShader("rendertype_entity_translucent_emissive")
                    .withFragmentShader("rendertype_entity_translucent_emissive")
                    .withSampler("Sampler0")
                    .withBlend(BlendFunction.TRANSLUCENT)
                    .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                    .withDepthWrite(false)
    ...
    public static final RenderPipeline CHAMS_FILL_THROUGH_WALLS_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(TRANSFORMS_AND_PROJECTION_SNIPPET)
                    .withLocation("pipeline/chams_fill_through_walls")
                    .withVertexShader("core/position_color")
                    .withFragmentShader("core/position_color")
                    .withBlend(BlendFunction.TRANSLUCENT)
                    .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
    ...
    public static final RenderLayer CHAMS_FILL_THROUGH_WALLS_LAYER = RenderLayer.of(
            "chams_fill_through_walls",
            RenderSetup.builder(CHAMS_FILL_THROUGH_WALLS_PIPELINE)
                    .translucent()
                    .expectedBufferSize(8192)
                    .build()
    );

    public static final RenderPipeline CHAMS_FILL_NORMAL_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(TRANSFORMS_AND_PROJECTION_SNIPPET)
                    .withLocation("pipeline/chams_fill_normal")
                    .withVertexShader("core/position_color")
                    .withFragmentShader("core/position_color")
                    .withBlend(BlendFunction.TRANSLUCENT)
                    .withDepthTestFunction(DepthTestFunction.LEQUAL_DEPTH_TEST)
    ...
    public static final RenderLayer CHAMS_FILL_NORMAL_LAYER = RenderLayer.of(
            "chams_fill_normal",
            RenderSetup.builder(CHAMS_FILL_NORMAL_PIPELINE)
                    .translucent()
                    .expectedBufferSize(8192)
                    .build()
    );

    public static final RenderPipeline CHAMS_OUTLINE_THROUGH_WALLS_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(TRANSFORMS_AND_PROJECTION_SNIPPET)
                    .withLocation("pipeline/chams_outline_through_walls")
                    .withVertexShader("core/position_color")
                    .withFragmentShader("core/position_color")
                    .withBlend(BlendFunction.LIGHTNING)
                    .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
    ...
    public static final RenderLayer CHAMS_OUTLINE_THROUGH_WALLS_LAYER = RenderLayer.of(
            "chams_outline_through_walls",
            RenderSetup.builder(CHAMS_OUTLINE_THROUGH_WALLS_PIPELINE)
                    .translucent()
                    .expectedBufferSize(8192)
                    .build()
    );

    public static final RenderPipeline CHAMS_OUTLINE_NORMAL_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(TRANSFORMS_AND_PROJECTION_SNIPPET)
                    .withLocation("pipeline/chams_outline_normal")
                    .withVertexShader("core/position_color")
                    .withFragmentShader("core/position_color")
                    .withBlend(BlendFunction.LIGHTNING)
                    .withDepthTestFunction(DepthTestFunction.LEQUAL_DEPTH_TEST)
    ...
    public static final RenderLayer CHAMS_OUTLINE_NORMAL_LAYER = RenderLayer.of(
            "chams_outline_normal",
            RenderSetup.builder(CHAMS_OUTLINE_NORMAL_PIPELINE)
                    .translucent()
                    .expectedBufferSize(8192)
                    .build()
    );
