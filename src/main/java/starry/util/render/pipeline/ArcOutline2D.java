    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("starry", "core/arc_outline"))
                    .withVertexShader(Identifier.of("starry", "core/arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("starry", "core/arc_outline_fragment"))
