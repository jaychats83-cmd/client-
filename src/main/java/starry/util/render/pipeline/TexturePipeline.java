...
public class TexturePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("starry", "pipeline/texture");
    private static final Identifier VERTEX_SHADER = Identifier.of("starry", "core/texture");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("starry", "core/texture");
