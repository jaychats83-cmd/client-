...
public class OutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("starry", "pipeline/outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("starry", "core/outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("starry", "core/outline");
