    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("starry", "core/arc"))
                    .withVertexShader(Identifier.of("starry", "core/arc_vertex"))
                    .withFragmentShader(Identifier.of("starry", "core/arc_fragment"))
