...
import starry.util.render.pipeline.Arc2D;
import starry.util.render.pipeline.ArcOutline2D;
...
public class Render2D {
    ...
    private static final Identifier BACKGROUND_TEXTURE = Identifier.of("starry", "textures/menu/backmenu.png");
