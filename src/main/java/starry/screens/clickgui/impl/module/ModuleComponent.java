package starry.screens.clickgui.impl.module;
...
import starry.modules.module.setting.SettingComponentAdder;
...
import starry.screens.clickgui.impl.module.handler.ModuleFavoriteHandler;
import starry.screens.clickgui.impl.module.handler.ModuleScrollHandler;
import starry.screens.clickgui.impl.module.render.ModuleListRenderer;
import starry.screens.clickgui.impl.module.render.SettingsPanelRenderer;
import starry.screens.clickgui.impl.module.util.ModuleDisplayHelper;
import starry.screens.clickgui.impl.settingsrender.*;
...
public class ModuleComponent implements IMinecraft {
    ...
    public ModuleComponent() {
        ...
        this.listRenderer = new ModuleListRenderer(animationHandler, displayHelper);
    ...
    public void renderSettingsPanel(DrawContext context, float x, float y, float width, float height,
        ...
        settingsRenderer.render(context, selectedModule, bindingModule, settingComponents, x, y, width, height,
                mouseX, mouseY, delta, guiScale, alphaMultiplier, scrollHandler, animationHandler, bindHandler);
    }
