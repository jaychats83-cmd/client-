...
public class ModuleListRenderer {
    ...
    public ModuleListRenderer(ModuleAnimationHandler animationHandler, ModuleDisplayHelper displayHelper) {
            ...
            if (interactive) {
                ...
                if (hasSettings) {
                    ...
                    if (selectedIconAnim < 0.99f) {
                        ...
                        Fonts.BOLD.draw(StringHelper.decrypt(new byte[]{100, (byte)-19, 113}), iconBaseX + 1f, iconY - 1f, 7 * scale, new Color(150, 150, 150, (int) dotsAlpha).getRGB());
                    }
                }
            }
        }
