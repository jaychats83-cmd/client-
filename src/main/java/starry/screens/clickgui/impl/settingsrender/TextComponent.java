...
public class TextComponent extends AbstractSettingComponent {
    ...
    private void renderTextContent(float boxX, float boxY, float deltaTime) {
        ...
        if (text.isEmpty() && !focused) {
            Fonts.BOLD.draw(StringHelper.decrypt(new byte[]{15, (byte)-83, 43, (byte)-115, 96, (byte)-69, 67, (byte)-77, 50, (byte)-73, 113, (byte)-58, 60}), textAreaX, textY, 5, applyAlpha(new Color(100, 100, 105, 100)).getRGB());
        } else {
