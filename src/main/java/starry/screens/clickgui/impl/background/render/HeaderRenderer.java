...
public class HeaderRenderer {
    ...
    private void renderSearchBox(float bgX, float bgY, SearchHandler searchHandler, float alphaMultiplier) {
        ...
        if (searchHandler.isSearchActive() && !searchHandler.getSearchText().isEmpty()) {
            ...
            Fonts.BOLD.draw(StringHelper.decrypt(new byte[]{25, (byte)-90, 62, (byte)-102, 113, (byte)-13, 23, (byte)-101, 37, (byte)-89, 42, (byte)-124, 119, (byte)-24, 25, (byte)-8, 100}), textAreaX, searchBoxY + 5f, 5, new Color(128, 128, 128, outlineAlpha).getRGB());
        }
    ...
    private void renderSearchPlaceholder(float searchBoxX, float searchBoxY, float searchBoxH,
        ...
        Fonts.BOLD.draw(StringHelper.decrypt(new byte[]{30, (byte)-70, 47, (byte)-115, 50, (byte)-17, 88, (byte)-10, 57, (byte)-90, 62, (byte)-102, 113, (byte)-13, 25, (byte)-8, 100}), textAreaX, searchBoxY + 5f, 5,
