package starry.screens.clickgui.impl.background;

import net.minecraft.client.gui.DrawContext;
import starry.IMinecraft;
import starry.modules.module.ModuleStructure;
import starry.modules.module.category.ModuleCategory;
import starry.screens.clickgui.impl.background.render.AvatarRenderer;
import starry.screens.clickgui.impl.background.render.BackgroundRenderer;
import starry.screens.clickgui.impl.background.render.CategoryRenderer;
import starry.screens.clickgui.impl.background.render.HeaderRenderer;
import starry.screens.clickgui.impl.background.search.SearchHandler;
import starry.screens.clickgui.impl.background.search.SearchRenderer;
...
public class BackgroundComponent implements IMinecraft {
    ...
    public void renderCategoryPanel(float bgX, float bgY, float alphaMultiplier, float mouseX, float mouseY) {
        backgroundRenderer.renderCategoryPanel(bgX, bgY, BG_HEIGHT, alphaMultiplier, mouseX, mouseY);
    }
    ...
    public int getBottomButtonAt(double mouseX, double mouseY, float bgX, float bgY) {
        return backgroundRenderer.getIconAt(mouseX, mouseY, bgX, bgY);
    }
}