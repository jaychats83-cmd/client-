...
public class Staff extends AbstractHudElement {
    ...
    private static final Identifier STEVE_SKIN = Identifier.of("starry", "textures/entity/player/wide/steve.png");
    ...
    public void drawDraggable(DrawContext context, int alpha) {
        ...
        Fonts.BOLD.draw(StringHelper.decrypt(new byte[]{25, (byte)-73, 62, (byte)-114, 116}), x + 8, y + 6.5f, 6, new Color(255, 255, 255, bgAlpha).getRGB());
